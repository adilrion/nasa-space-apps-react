              ...
              <BrowserRouter>
                  ...
                  <div className="">
                      <Routes>
                          ...
                          />
                          <Route
                              path="/visualization/real-time-updates"
                              element={<EarthquakeInformation />}
                          />
                          <Route
                              path="/visualization/data-chart"
                              element={<DataChart />}
                          />
                          <Route
                              path="/visualization/comparison-chart"
                              element={<ComparisonChart />}
                          />
                          <Route
                              path="/visualization/timing-and-alerts"
                              element={<TimingAndAlerts />}
                          />
                      </Routes>
                  </div>
                  <Footer />
